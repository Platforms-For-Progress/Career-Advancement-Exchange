...
function Edit() {
  ...
  useEffect(() => {
    const tempRID = window.location.pathname.slice(6);
    setLookupRID(tempRID);
    console.log(tempRID);
  ...
  return (
    <div className="editer">
      ...
      <div className="edit2" onClick={navBack}>
        Back to User Requested Website
      </div>
    </div>
