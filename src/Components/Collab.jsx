...
const AddEducation = () => {
    ...
    const onGraduationDateChange = (event) => setGraduationDate(event.target.value);
...
const Collab = () => {
    ...
    return (
        ...
        <div className="startOfPage">
            <div className="left">
        <button className = "button" onClick={ handleClick } >Pick Background Color</button>
        ...
        <div className="right">
            ...
            <FontPicker 
                ...
                onChange={nextFont => setFont(nextFont.family) && console.log(font)}
        ...
        <div className="collabBackground apply-font" style={{backgroundColor:color, color: "black", fontFamily : {font}}}>
        ...
        <div className="viewport" style={{backgroundColor:color, color: "black"}}>
        ...
        {Array.from(Array(counter)).map((e, i) => {
            ...
            return (
                <div>
                    <br></br>
                    <input type="text" name={i} className={0} key={e} onChange={handleOnChange2} placeholder="School"></input>
                    <input type="text" name={i} className = {1} key={e} onChange={handleOnChange2} placeholder="Degree"></input>
                    <input type="text" name={i} key={e} className = {2} onChange={handleOnChange2} placeholder="Major"></input>
                    <br></br>
                </div>
            )
        })}
